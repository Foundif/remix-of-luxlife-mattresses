...
import cutawayAsset from "@/assets/luxlife-cutaway.mp4.asset.json";
...
export function AnatomySection() {
  ...
  const seekToLayer = (index: number) => {
    ...
    if (videoRef.current) {
      videoRef.current.currentTime = LAYERS[index].timeStart + 0.1;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7">
            <div className="relative rounded-2xl overflow-hidden bg-black/60 border border-white/15 shadow-2xl backdrop-blur-sm group">
              {/* HTML5 Video with fallback to CDN URL */}
              <video
                ref={videoRef}
                src={cutawayAsset?.url || "/__l5e/assets-v1/5cbd9247-daf0-42a6-9fed-3429b39c1f37/luxlife-cutaway.mp4"}
                autoPlay
                loop
                muted={isMuted}
                playsInline
